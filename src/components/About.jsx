...
const About = () => {
  ...
  return (
    <section
      id="about"
      ref={aboutRef}
      className="bg-white px-8 py-20 sm:py-24 md:py-28"
    >
      <div className="w-full mx-auto max-w-[1200px] flex flex-col gap-16">
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          >
            <div className="relative rounded-xl overflow-hidden shadow-xl group h-[500px]">
              <img
          ...
          {/* Text Column */}
          <div
            className={`lg:w-1/2 space-y-6 transition-all duration-1000 delay-500 ${
              isVisible
                ? "opacity-100 translate-x-0"
                : "opacity-0 translate-x-10"
            }`}
          >
            ...
            <div className="bg-amber-50 border-l-4 border-amber-400 p-4 rounded-r-lg">
              <h4 className="font-bold text-gray-800 mb-2">
                {ABOUT_CONTENT.APPROACH_TITLE}
              </h4>
              <p className="text-gray-600">{ABOUT_CONTENT.APPROACH_TEXT}</p>
            </div>
